...
from .common.helpers import update_pbonus as helper_update_pbonus
...
########## Economic/Asset Commands ##########
    ...
    async def ctconvert(self, ctx: commands.Context, amount: str = None):
        ...
        if amount is None:
            await ctx.send("How many gems would you like to convert? Use `.ctconvert #`")
            return
